...
*/
function isFake(statement) {
	if (sha256(statement) === hash) {
    	return('Document is legit 👍');
	} else {
    	return("Whoa! That's a fake document");
	}
}
...
blockchain itself
*/
console.log(isFake('Give 50 BTC from my wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa to Eve'));
console.log(isFake(document));